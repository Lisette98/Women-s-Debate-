...
$(function ($) {
     ...
     //USE YOUR OWN FLICKR API KEY
            ...
            $.mbFlickr.flickr_api_key="f40779ab07dd09e5890f48e3618296b3"; //this is our Flickr API key. Create your own
            $.mbFlickr.defaults.size="surce"; //  medium / surce
            $.mbFlickr.defaults.per_page=100;
            $.mbFlickr.defaults.flickr_photoset_id='72157629177281331'; //Keep any Flickr Set ID here
